...
class StyleSheet extends TreeNode {
  ...
  List<RuleSet> get ruleSets => topLevels.map((e) => e as RuleSet).toList();
}
...
class Declaration extends TreeNode {
  ...
  Expressions get expression => _expression;
...
class VarDefinition extends Declaration {
  ...
  VarDefinition(Identifier definedName, Expressions expr, SourceSpan span)
